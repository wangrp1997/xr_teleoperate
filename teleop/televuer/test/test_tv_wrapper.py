...
def run_test_tv_wrapper():
    ...
    img_client = ImageClient(host="192.168.0.129")
    ...
    tv_wrapper = TeleVuerWrapper(use_hand_tracking=use_hand_track, 
                                ...
                                webrtc_url=f"https://192.168.0.129:{camera_config['head_camera']['webrtc_port']}/offer"
                                )
    # pure televuer
    # tv_wrapper = TeleVuerWrapper(use_hand_tracking=use_hand_track, 
    #                              binocular=True, 
    ...
    #                              zmq=True,
    #                              webrtc=True, 
    #                              webrtc_url="https://192.168.0.129:60001/offer"
    #                              )
    try:
